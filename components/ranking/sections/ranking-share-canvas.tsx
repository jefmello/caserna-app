        ...
        >
          <div className="flex items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              >
                <span className={`text-3xl ${isDarkMode ? theme.darkAccentText : theme.primaryIcon}`}>🏆</span>
              </div>
              <div>
                <p
          ...
          <div className="mt-7 grid grid-cols-4 gap-4">
            ...
            >
              ...
              <p className="mt-2 text-[30px] font-extrabold tabular-nums">{"pontos" in (leader || {}) ? leader?.pontos || 0 : 0}</p>
            </div>
            <div
              className={`rounded-[22px] border px-4 py-4 ${
                isDarkMode ? "border-white/10 bg-[#0f172a]" : "border-black/5 bg-white"
            ...
            >
              ...
              <p className="mt-2 text-[30px] font-extrabold tabular-nums">{"vitorias" in (leader || {}) ? leader?.vitorias || 0 : 0}</p>
            </div>
            <div
              className={`rounded-[22px] border px-4 py-4 ${
                isDarkMode ? "border-white/10 bg-[#0f172a]" : "border-black/5 bg-white"
            ...
            >
              ...
              <p className="mt-2 text-[30px] font-extrabold tabular-nums">{"podios" in (leader || {}) ? leader?.podios || 0 : 0}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      >
        ...
        >
          <div className="flex items-start justify-between gap-6">
            ...
            <div className={`rounded-full border px-5 py-2 text-[15px] font-bold uppercase tracking-[0.14em] ${duelIntensity.tone}`}>
              {duelIntensity.label}
            </div>
          </div>
          ...
          <div className="mt-7 grid grid-cols-[1fr_auto_1fr] items-center gap-4">
            ...
            <div
              className={`rounded-[26px] border px-6 py-5 text-center ${
                isDarkMode ? `${theme.darkAccentBorder} ${theme.darkAccentBgSoft || theme.darkAccentBg}` : `${theme.primaryBorder} bg-white`
              }`}
            >
              <p
                className={`text-[12px] font-bold uppercase tracking-[0.16em] ${
          ...
          <div className="mt-8 grid grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="mt-2 text-[26px] font-extrabold tabular-nums">
                {filteredRanking[1] && leader && "pontos" in leader ? Math.max((leader.pontos || 0) - filteredRanking[1].pontos, 0) : 0} pts
              </p>
              <p
                className={`mt-1 text-[18px] font-semibold ${
                  isDarkMode ? "text-zinc-300" : "text-zinc-700"
