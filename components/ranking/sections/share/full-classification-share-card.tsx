...
export default function FullClassificationShareCard({
  cardRef,
  isDarkMode,
  theme,
  category,
    ...
    >
      ...
      <div
        className={`rounded-[26px] border px-6 py-5 ${
          isDarkMode ? `${theme.darkAccentBorder} bg-[#111827]` : `${theme.heroBorder} bg-white/92`
        }`}
      >
        <div className="flex items-center justify-between gap-5">
          <div className="flex items-center gap-4">
            ...
            >
              <span
                className={`text-[28px] ${isDarkMode ? theme.darkAccentText : theme.primaryIcon}`}
              >
                📋
              </span>
            </div>
            ...
            <div>
              ...
              <h2 className="mt-1.5 text-[34px] leading-none font-extrabold tracking-[0.03em]">
                CASERNA KART RACING
              </h2>
              <p
          ...
          <div
            className={`rounded-full border px-4 py-1.5 text-[14px] font-bold tracking-[0.12em] uppercase ${
              isDarkMode
              ...
              <div className="grid grid-cols-5 gap-2.5 text-center">
                {[
                  ...
                  >
                    ...
                    <p className="mt-1 text-[17px] leading-none font-extrabold tabular-nums">
                      {stat.value}
                    </p>
                  </div>
                ))}
