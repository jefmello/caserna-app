        ...
        <div className="relative">
          ...
          <div className="p-3">
            ...
            >
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-[minmax(340px,52%)_1fr] md:gap-5 lg:grid-cols-[minmax(560px,60%)_1fr] lg:gap-7 xl:grid-cols-[minmax(680px,64%)_1fr] xl:gap-8">
