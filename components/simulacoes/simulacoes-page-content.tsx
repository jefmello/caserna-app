  ...
  return (
    <div
      className={`overflow-hidden rounded-[22px] border shadow-sm ${
        isDarkMode ? `${theme.darkAccentBorder} bg-[#111827]` : "border-black/5 bg-white"
      }`}
    >
      <div className="flex items-center gap-3 px-4 py-4">
        ...
        <div>
          ...
          <p className={`mt-0.5 text-[12px] ${isDarkMode ? "text-zinc-400" : "text-zinc-500"}`}>
            {subtitle}
          </p>
        </div>
      </div>
    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <p className={`mt-1 text-[12px] ${isDarkMode ? "text-zinc-400" : "text-zinc-500"}`}>
            Probabilidade se vencer a próxima etapa:{" "}
            {Number(scenario.winProbability || 0).toFixed(2)}%
          </p>
        </div>
          ...
          >
            ...
            <CardContent className="space-y-3">
              ...
              >
                ...
                <p
                  className={`mt-2 text-[20px] leading-tight font-extrabold ${
                    isDarkMode ? "text-white" : "text-zinc-950"
                  }`}
                >
                ...
                mathematicalStatusRows.map(({ pilot, pointsBehind, stillAlive }, index) => (
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <span
                        className={`shrink-0 rounded-full border px-2.5 py-1 text-[10px] font-semibold tracking-[0.12em] uppercase ${
                          stillAlive
                            ? isDarkMode
                              ? "border-emerald-500/30 bg-emerald-500/10 text-emerald-300"
                              : "border-emerald-200 bg-emerald-50 text-emerald-700"
          ...
          >
            ...
            <CardContent className="space-y-3">
              <button
                type="button"
                onClick={() =>
                  titleProbabilities[0] && handleSelectPilot(titleProbabilities[0].pilot)
                }
                title="Abrir piloto"
              ...
              <button
                type="button"
                onClick={() => {
                  const biggest = [...nextStageScenarios].sort(
              ...
              >
                ...
                >
                  {nextStageScenarios[0]
                    ? getPilotFirstAndLastName(
                        [...nextStageScenarios].sort((a, b) => b.winDelta - a.winDelta)[0].pilot
                          .piloto
                      )
              ...
              >
                ...
                >
                  ...
                  . A quantidade de pontos restantes e o peso da próxima etapa são o centro da
                  leitura desta tela.
                </p>
